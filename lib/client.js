...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function DeepSeekBalanceCard() {
			...
			const dailyValues = dailyData.map((d) => chartMetric === "cost" ? (currency === "USD" ? (d.costUsd || 0) : (d.cost || 0)) : (d.totalTokens || 0));
											...
											children: [
												...
												jsxs("div", {
													...
													children: [
														...
														jsx("span", { className: "dsbc-stats-value", children: stats ? formatCost(currency === "USD" ? stats.costUsd : stats.cost, currency) : "—" })
													]
												}),
												jsxs("div", {
													className: "dsbc-stats-row",
												...
												(statsRange === "7d" || statsRange === "30d") && dailyData.length > 0
													? jsxs("div", {
														...
														children: [
															jsxs("div", {
																...
																children: [
																	...
																	jsx("button", {
																		type: "button",
																		className: chartMetric === "tokens" ? "active" : "",
															...
															jsx("div", {
																...
																children: dailyData.map((d, i) => {
																	const value = chartMetric === "cost" ? (currency === "USD" ? (d.costUsd || 0) : (d.cost || 0)) : (d.totalTokens || 0);
																	const pct = Math.max(2, Math.round(value / dailyMax * 100));
																	const label = chartMetric === "cost" ? formatCost(currency === "USD" ? d.costUsd : d.cost, currency) : formatTokens(d.totalTokens);
																	const dayText = statsRange === "7d" ? d.date.slice(5) : d.date.slice(8);
																	return jsx("div", {
																		key: d.date,
																		...
																		children: [
																			...
																			jsx("div", {
																				className: "dsbc-chart-day" + (statsRange === "30d" ? " dsbc-chart-day-30" : ""),
																				children: dayText
																			})
																		]
																	});
								...
								children: [
									...
									jsxs("div", {
										...
										children: [
											...
											jsx("div", {
												className: "dsbc-settings-info",
												children: "如果账号同时有人民币和美元余额，选择人民币可避免余额与消费金额币种冲突。"
											})
										]
									}),
									jsxs("div", {
