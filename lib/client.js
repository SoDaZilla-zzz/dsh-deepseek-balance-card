			...
			style.textContent = `
				...
				.dsbc-3d-layer {
					...
					background: linear-gradient(
						135deg,
						color-mix(in srgb, var(--dsbc-tint, var(--dsw-alias-bg-overlay, #ffffff)) 42%, transparent),
						color-mix(in srgb, var(--dsbc-tint, var(--dsw-alias-bg-overlay, #ffffff)) 22%, transparent)
					);
					border: 1px solid color-mix(in srgb, var(--dsbc-tint, var(--dsw-alias-bg-overlay, #ffffff)) 22%, transparent);
					z-index: 0;
					transform-style: preserve-3d;
				}
