 ...
 *   POST /api/liquid-glass-balance-card/settings
 ...
 * stored on the host under `$DSH_HOME/storages/dsh-liquid-glass-balance-card.json`
...
export function apply(ctx) {
  ...
  registerRoute(ctx, "exact", "/api/liquid-glass-balance-card/settings", async (req, res) => {
    try {
      if (req.method === "POST") {
  ...
  registerRoute(ctx, "exact", "/api/liquid-glass-balance-card/balance", async (req, res) => {
    try {
      const manual = readState(ctx);
  ...
  registerRoute(ctx, "exact", "/api/liquid-glass-balance-card/stats", async (req, res) => {
    try {
